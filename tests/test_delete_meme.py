...
def test_delete_meme_without_token(
        examination_and_update_token, remove_token_from_headers, create_meme_fixture, delete_meme_endpoint
):
...
def test_delete_meme_with_invalid_token(
        examination_and_update_token, create_invalid_token, create_meme_fixture, delete_meme_endpoint
):
